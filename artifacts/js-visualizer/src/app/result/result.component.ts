...
/** Classify a step string into a visual category for colour-coding. */
...
@Component({
    ...
    <div class="result-wrapper">
      @if (loading) {
        ...
        <div class="state-msg empty">
          <span>
            Paste some JavaScript in the editor and click
            <strong>Run Code</strong> to see the execution steps.
          </span>
        </div>
      } @else {
        <ol class="steps-list">
  ...
  styles: [
    `
      ...
      /* Colour-coding by step kind */
      .step-item[data-kind="context"] {
        border-left-color: #6366f1;
      }
      .step-item[data-kind="hoist"] {
        border-left-color: #f59e0b;
      }
      .step-item[data-kind="start"] {
        border-left-color: #4ade80;
      }
      .step-item[data-kind="log"] {
        border-left-color: #22d3ee;
      }
      .step-item[data-kind="call"] {
        border-left-color: #a78bfa;
      }
      .step-item[data-kind="assign"] {
        border-left-color: #fb923c;
      }
      .step-item[data-kind="return"] {
        border-left-color: #64748b;
      }
      .step-item[data-kind="default"] {
